...
$mailbody=$mailbody."&nbsp;&nbsp;&nbsp;&nbsp;"."客户姓名：".$_POST["name"]."<br>";
// $mailbody=$mailbody."&nbsp;&nbsp;&nbsp;&nbsp;"."Institution=".$_POST["institution"]."<br>";
$mailbody=$mailbody."&nbsp;&nbsp;&nbsp;&nbsp;"."客户Email：".$_POST["email"]."<br>";
$mailbody=$mailbody."&nbsp;&nbsp;&nbsp;&nbsp;"."客户消息：".$_POST["message"]."<br>";
...
$mail->AddReplyTo($_POST["email"],$mailfrom); 
                                            // 设置邮件回复人地址和名称
$mail->Subject    = $_POST["subject"];                 // 设置邮件标题
